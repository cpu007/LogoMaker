...
public class AppGUI implements AppStyleArbiter {
    ...
    protected ToolBar fileToolbarPane;
    ...
    private void initFileToolbar(AppTemplate app) {
        fileToolbarPane = new ToolBar();
        //fileToolbarPane.setHgap(1);
     ...
     * pane container.
     */
    public Button initChildButton(ToolBar toolbar, String icon, String tooltip, boolean disabled) {
        PropertiesManager props = PropertiesManager.getPropertiesManager();
